...
if( !$section_is_empty) { ?>
    ...
    <section >
        <div class="section-overlay-layer">
            ...
            <!-- SECTION HEADER -->
                <div class="section-header">
                    <h2 class="dark-text">Découvrez le parcours d'une brosse à dents en plastique</h2>
                    <div class="colored-line"></div>
                    <div class="sub-heading llorix_one_lite_only_customizer"></div>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12" style="position: relative;padding-bottom: 56.25%; /* 16:9 */padding-top: 25px;height: 0;">
                                <iframe style="position: absolute;top: 0;left: 0;width:100%;height:100%;" src="https://www.youtube.com/embed/TX21EEVJ6N8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
